 ...
 div .w{
  ...
  div .w a{
   ...
   div .e{
     ...
     border: 0px solid #000000; 
     border-radius: 10px; 
     width:226px; height:2710px;  
     margin: 16px 11px 11px 14px;
} 
   ...
   div.z{
     ...
     color:#fff; 
     font-weight:bold; 
     box-shadow: 2px 2px 7px -1px #1e90ff;
}
   div.z:hover{
     background:#87cefa; 
     border: 1px solid #000000;
...
<div class="b">
 ...
 <aside>
      <a href="index.html">Китобхона</a>
	     <a href="#">Профили ман</a>
		    <a href="#">Харитаи Деҳа</a>
			   <a href="#">Суроға</a>
			     </aside>
				 </div>
    </div>
